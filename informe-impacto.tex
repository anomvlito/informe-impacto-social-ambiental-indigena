...
\definecolor{primarygray}{RGB}{30,30,30}
\definecolor{accentgray}{RGB}{80,80,80}

\usepackage[colorlinks=true, linkcolor=primarygray, citecolor=accentgray,
            urlcolor=primarygray, bookmarks=true]{hyperref}
...
\usepackage{titlesec}
\titleformat{\section}{\large\bfseries\color{primarygray}}{\thesection.}{0.6em}{}[\titlerule]
...
\begin{titlepage}
  ...
  \vspace{0.8cm}
  {\LARGE\bfseries\color{primarygray}
...
de \textbf{8.872 habitantes} según las proyecciones del Censo 2024 ---concentrada principalmente en el poblado de Hanga Roa--- \citep{INE2024},
...
de justificar su pertinencia dentro del marco de inversión pública. Los diagnósticos
aquí presentados se sostienen en evidencia empírica recolectada con 17 actores clave
del ecosistema deportivo y comunitario de la isla durante 2024--2025, mediante
metodología de \textbf{Teoría Fundamentada Constructivista} \citep{charmaz2014} y
principios ético-metodológicos polinésicos (\textbf{Talanoa} y \textbf{Vā})
\citep{prescott2008, kaili2005}. Las citas textuales que aparecen en el documento
provienen de entrevistas en profundidad con deportistas, entrenadores, dirigentes,
familias y profesionales de salud y educación de la isla. Los principios de diseño
están sujetos a \textbf{validación comunitaria} antes de cualquier implementación.
...
territorio continental. Las siguientes condicionantes logístico-económicas
definen la realidad del deporte en Rapa Nui \citep{ortega2026}:
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
  \item Población: \textbf{8.872 habitantes} (proyección Censo 2024) \citep{INE2024, BCN2025}, frente a los 7.750 registrados en el Censo 2017
  ...
  \item \textbf{4 establecimientos educacionales} con aproximadamente \textbf{1.500 estudiantes} \citep{BCN2025}, población directamente beneficiaria de una infraestructura atlética
  \item Organismo deportivo comunal activo: Corporación Municipal de Deportes y Recreación (COMDYR)
\end{itemize}

\subsection{Fragmentación institucional y brechas actuales}

La oferta deportiva en Rapa Nui es \textbf{fragmentada}: cada disciplina negocia
por separado con federaciones nacionales, la gestión es débil y voluntarista, y hay
escasez virtual de apoyo multidisciplinario (prevención de lesiones, salud mental
deportiva, nutrición) \citep{ortega2026}.
...
\begin{conceptoclave}
  \textbf{Régimen colonial-burocrático} (concepto estructural):
...
que refuerza brechas estructurales documentadas en terreno \citep{ortega2026}.
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
  ...
  \item Subutilización del potencial turístico del deporte: tras la reapertura de la
        isla en agosto de 2022 (luego de 868 días de cierre pandémico), Rapa Nui
        recibió aproximadamente \textbf{35.000 visitantes} en su primer año de
        operación \citep{TurismoRapaNui2023}. Una infraestructura atlética
        multipropósito habilita el turismo deportivo como componente de la oferta
\end{itemize}
...
En Rapa Nui, el \textbf{deporte como medio para mejorar la salud física} es una
narrativa central y proactiva en la comunidad. Sin embargo, esta disposición choca
con brechas estructurales concretas: el déficit de kinesiólogos y de apoyo
multidisciplinario obliga a la comunidad a aprender ``a porrazo'' por dolores
\citep{ortega2026}.
...
Un indicador particularmente crítico es la \textbf{evolución de la obesidad infantil}:
en 2004, el 12,5\% de los escolares de 1° básico presentaba obesidad, cifra muy
inferior al promedio continental (18,5\%). Para 2014, ese porcentaje casi se duplicó
hasta alcanzar el \textbf{24\%}, aproximándose a los niveles del continente. El factor
principal identificado es la \textit{``continentalización''}: el uso masivo de
dispositivos digitales que reemplaza la actividad física al aire libre que
históricamente caracterizó a la infancia rapanui \citep{ObesidadRapaNui}. A pesar de
esto, más del \textbf{64\%} de los adultos residentes reporta realizar actividad
física periódicamente, lo que convierte a Rapa Nui en una de las comunas con
mejores indicadores de actividad física en Chile \citep{PUCVSalud}. Esta brecha
entre generaciones refuerza la urgencia de una infraestructura deportiva que
responda a las necesidades específicas de niños y jóvenes.
...
La variación en trayectorias deportivas ---por qué algunas son sostenidas y otras
intermitentes o truncas--- \textbf{no depende de la motivación individual}, sino de
la capacidad colectiva de la comunidad para activar condiciones estructurales
\citep{ortega2026}.
...
La práctica deportiva actúa como \textbf{motor de cohesión comunitaria} en Rapa Nui.
El ciclo virtuoso se alimenta de la \textit{persistencia en la participación}, que
genera \textit{percepción de competencia y logro}, reforzando el \textit{valor de
la participación} \citep{ortega2026}. Cuando los mecanismos de apoyo colectivo
operan efectivamente, se observan:
...
Los \textbf{\textit{koros}} (abuelos, ancianos conocedores) no son meros observadores
del deporte: son \textbf{portadores de saberes técnicos deportivos} equivalentes al
entrenamiento formal, transmitidos intergeneracionalmente a través de práctica y
relato \citep{ortega2026}.
...
desarrollo social, deportivo y territorial de Rapa Nui. La comunidad rapanui
no concibe la pista como un equipamiento técnico, sino como un \textit{espacio de
...
\subsection{Contexto de inversión pública activa en Rapa Nui}

El proyecto no se propone en un vacío institucional: el Estado chileno tiene
actualmente un \textbf{plan de inversión activo y prioritario} en Rapa Nui. El
Presidente Boric presentó en 2026 el Plan de Inversión del Aeropuerto Mataveri
(2025--2035), que contempla más de \textbf{US\$400 millones} en tres etapas
\citep{AeropuertoMataveri2026}. El BID aprobó en 2025 una operación de
\textbf{US\$15 millones} para mejorar los servicios de agua y electricidad de la
isla \citep{BIDAguaRapaNui2025}. El MOP ejecuta la pavimentación de 40 kilómetros
de caminos y cinco obras de infraestructura pesquera y marítima por \$7.800 millones
de pesos. En este contexto, una pista de atletismo ---cuya inversión estimada es
comparable a una sola obra portuaria menor del plan--- resulta \textbf{coherente,
proporcional y oportuna} respecto al impulso de desarrollo en curso.
...
El Fundo Vaitea comprende 4.597 hectáreas de tierra fiscal ---el 27,7\% del
territorio total de la isla--- administrada por el Ministerio de Bienes Nacionales.
Existe un precedente directo y reciente: en 2024, Bienes Nacionales destinó
\textbf{10 hectáreas del Fundo Vaitea} al Ministerio de las Culturas para la
construcción del futuro Museo Antropológico de Rapa Nui \citep{BienesNacionalesVaitea2024}.
Este mecanismo de destinación de suelo fiscal es el mismo que aplicaría para
el recinto atlético, con el procedimiento ya probado institucionalmente.
...
\subsection{Referencia de costos comparados}

Para dimensionar la inversión requerida, se dispone de referentes nacionales recientes.
La construcción de una \textbf{pista atlética de 6 andariveles en Limache} (Región de
Valparaíso, 2024), con áreas para saltos horizontales, lanzamiento de martillo y disco,
y superficie sintética Rekortan certificada por World Athletics, requirió una
\textbf{inversión de \$950.000.000 CLP} \citep{PistaLimache2024}. Este caso constituye
el referente más reciente disponible en Chile. Para Rapa Nui, la condición de
insularidad implica un \textbf{sobrecosto logístico estimado de 30--50\%} sobre el
costo continental, derivado del transporte marítimo o aéreo de todos los materiales,
la necesidad de mano de obra especializada con contratos según la Ley
21.070 \citep{Ley21070}, y los tiempos de despacho extendidos. Considerando estos
factores, una estimación conservadora para un recinto base en Rapa Nui
oscila entre \$1.200 y \$1.400 millones de pesos, con escenario ampliado
(graderías, iluminación LED, áreas complementarias) que podría llegar a \$2.100
millones. En cuanto a proveedores, \textbf{Sportwelt} es actualmente la única empresa
en Chile con materiales certificados por World Athletics, con más de 350.000 m²
instalados a nivel nacional \citep{Sportwelt2024}.

Para instalaciones de referencia internacional, el \textbf{Centro Insular de Atletismo
de Tenerife (CIAT)} ---reconocido incluso por el MOMA de Nueva York--- demuestra
que una isla puede desarrollar y sostener infraestructura atlética de clase mundial
con gestión pública insular \citep{CIATTenerife}. Este modelo es directamente
aplicable al concepto de ``Centro Atlético del Pacífico Sur'' propuesto para
Rapa Nui.
...
\textbf{Positivos:} sustitución de actividades recreativas motorizadas (fuente
documentada de lesiones y riesgo en la comunidad) \citep{ortega2026}, creación de
espacio verde complementario, mejoramiento del paisaje en área urbana de Hanga Roa.
...
El \textbf{primer y más crítico factor} para el éxito de cualquier iniciativa
deportiva en Rapa Nui es la \textbf{legitimidad local}: que la iniciativa tenga
origen y respaldo comunitario explícito, no que sea percibida como ``de afuera''
\citep{ortega2026}.

Esto no es solo un elemento deseable: es una condición sin la cual las iniciativas
fracasan, independientemente de sus recursos. Iniciativas bien financiadas han
colapsado en Rapa Nui por falta de respaldo comunitario \citep{ortega2026}.
...
El \textbf{Principio de Legitimidad Primero} \citep{ortega2026} establece el
siguiente proceso:
...
El desarrollo deportivo en Rapa Nui puede comprenderse a través de una
\textbf{teoría de cambio} construida desde el territorio: ``\textbf{Del potencial
al proyecto}'' \citep{ortega2026}. El éxito o fracaso de una iniciativa deportiva
no depende principalmente de la motivación individual de los atletas, sino de la
\textbf{capacidad colectiva de la comunidad} para activar cinco mecanismos de
traducción bajo condiciones estructurales adversas.
...
\begin{enumerate}[leftmargin=*, itemsep=8pt]
  ...
  \item \textbf{Cuidado integral del atleta}: La pista debe ser parte de un
    ...
    orientación nutricional. El \textbf{Equipo Mínimo Integral} recomendado
    \citep{ortega2026}: entrenador/a certificado/a, apoyo en salud mental,
...
documentada en el territorio \citep{ortega2026}.
...
\subsection{Fase 2: Consulta Indígena y validación territorial}

\begin{conceptoclave}
  \textbf{Requisito legal ineludible:} El \textbf{Convenio 169 de la OIT}
  \citep{Convenio169}, ratificado por Chile y vigente desde 2009, establece en su
  Artículo 6 la obligatoriedad de la \textbf{Consulta Previa, Libre e Informada}
  para toda medida administrativa que pueda afectar directamente a pueblos indígenas.
  Rapa Nui tiene pueblo indígena originario reconocido: la Consulta Previa
  \textbf{no es optativa}. Su omisión puede derivar en impugnación judicial y
  nulidad del proyecto, como ha ocurrido en otros casos en Chile
  \citep{DS66Consulta}. El proceso debe iniciarse \textit{antes} de cualquier
  decisión de localización o diseño.
\end{conceptoclave}

\begin{enumerate}[leftmargin=*, itemsep=3pt]
  \item \textbf{Proceso de Consulta Previa} con la comunidad rapanui, conforme al
        Convenio 169 OIT y Decreto Supremo N° 66/2013 \citep{DS66Consulta}:
        proceso previo, libre, informado y de buena fe, orientado a obtener
        consentimiento o acuerdo genuino
  \item Revisión jurídica del terreno en Fundo Vaitea y validación con Bienes
        Nacionales para destinación fiscal \citep{BienesNacionalesVaitea2024}
  \item Verificación de compatibilidad con el \textbf{Plan Regulador Comunal}
        y la \textbf{Ley 21.070} \citep{Ley21070} en cuanto a permisos de obra
        y contratación de personal externo
...
\begin{enumerate}[leftmargin=*, itemsep=3pt]
  ...
  \item Inspección arqueológica previa (Consejo de Monumentos Nacionales, Ley 17.288)
  \item Consulta al SEA sobre pertinencia de ingreso al SEIA \citep{SEAguias}
  \item Perfil técnico-económico con costos de ciclo de vida (incluyendo recambio
        de superficie sintética y sobrecosto logístico insular)
  \item Presupuesto detallado con sobrecosto insular (estimación base: referente
        Limache 2024 + 30--50\% factor insularidad) \citep{PistaLimache2024}
  \item Verificación de accesibilidad universal conforme a \textbf{Ley 20.422}
        \citep{Ley20422}: rampas, espacios reservados, señalética táctil, baños accesibles
\end{enumerate}
...
\begin{enumerate}[leftmargin=*, itemsep=4pt]
  ...
  \item Cumplimiento de \textbf{accesibilidad universal} (Ley 20.422 \citep{Ley20422}):
        toda obra pública en Chile debe ser accesible para personas con discapacidad.
        El diseño debe incorporar rampas, señalética táctil, espacios reservados en
        graderías y baños accesibles desde la etapa de proyecto arquitectónico
\end{enumerate}
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
  ...
  \item Número de establecimientos educacionales beneficiarios (actualmente: 4 estab., ~1.500 alumnos \citep{BCN2025})
  \item Programas deportivos activos en la comuna (diagnóstico actualizado 2025--2026, coordinado con COMDYR)
